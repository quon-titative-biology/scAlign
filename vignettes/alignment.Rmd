...
youngMouseSCE <- SingleCellExperiment(
    assays = list(counts = youngMouseSeuratObj@raw.data, scale.data = youngMouseSeuratObj@scale.data[genes.use,])
)

oldMouseSCE <- SingleCellExperiment(
    assays = list(counts = oldMouseSeuratObj@raw.data, scale.data = oldMouseSeuratObj@scale.data[genes.use,])
)
